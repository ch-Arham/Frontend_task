...
function StepSlider({ steps, setSelectedStep }) {
  ...
  function handleThumpPress(event) {
    const keyCodeValue = positionValue;
  ...
  function getLabel() {
    ...
    // console.log(steps[Math.round(value)].label);
    setSelectedStep(steps[Math.round(value)].label);
